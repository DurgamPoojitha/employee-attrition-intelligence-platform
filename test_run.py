...
lr_gs = RandomizedSearchCV(LogisticRegression(max_iter=1000, random_state=42),
...
dt_gs = RandomizedSearchCV(DecisionTreeClassifier(random_state=42),
...
at_risk["Replacement_Cost"] = at_risk.apply(
    lambda r: replacement_cost(r["MonthlyIncome"], r["JobLevel"], r["YearsAtCompany"]), axis=1)

total_cost    = at_risk["Replacement_Cost"].sum()
